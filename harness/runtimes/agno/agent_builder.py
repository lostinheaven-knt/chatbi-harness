...
_GOVERNANCE_PROTOCOL = (
    ...
    "UI rendering depends on it) + POST-PASS IMMUTABILITY (REV-001): the "
    "candidate you froze for review is binding. After PASS, output it "
    "UNCHANGED - do NOT reorganize, rephrase, or re-freeze the "
    "answer_body; any edit makes the frozen SHA drift and the delivery "
    "gate re-blocks (gate-msg: final candidate changed after review PASS). "
    "The delivered message ends with exactly ONE compact JSON object on "
    "the final line - {{\"answer_body\": \"<the verbatim markdown answer "
    "you already froze for review>\", \"provenance_footer\": \"<one "
    "line: source tier | review round | freshness | owner | confidence>\"}}. "
    "Escape newlines inside the JSON string values; write no prose after "
    "the object.\n"
