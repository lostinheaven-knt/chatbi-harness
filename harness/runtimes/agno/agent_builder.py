...
_GOVERNANCE_PROTOCOL = (
    ...
    "7. Freeze the final answer with chatbi_submit_candidate, then call "
    "chatbi_review — the answer is delivered only after the independent "
    "reviewer passes (REV-001).\n"
    "8. When a tool call is DENIED, read the recovery message and follow "
    ...
    "\"build a warehouse\".\n"
    "9. When you need input from the user, END your message with a "
    "question — the delivery gate treats question-ending messages as "
    "conversational handoffs, not deliveries.\n"
    "10. If you believe a governance rule, checkpoint, or denial is "
    ...
    "11. Non-analyze workflows (init, bootstrap, maintain-model, "
