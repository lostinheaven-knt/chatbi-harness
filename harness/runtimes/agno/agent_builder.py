...
_GOVERNANCE_PROTOCOL = (
    ...
    "chatbi_query_source. "
    "On the bootstrap turn, STOP after chatbi_build_plan: present the "
    "plan and wait for the operator to confirm caliber. Do NOT "
    ...
    "turn call chatbi_dbt_draft once per planned model (parallel ok) "
    "with relative_path=models/{{layer}}/{{name}}.sql (copy "
