...
_GOVERNANCE_PROTOCOL = (
    ...
    "5. Freeze the final answer with chatbi_submit_candidate, then call "
    "chatbi_review — the answer is delivered only after the independent "
    "reviewer passes (REV-001).\n"
    "6. When a tool call is DENIED, read the recovery message and follow "
    ...
    "\"build a warehouse\".\n"
    "7. When you need input from the user, END your message with a "
